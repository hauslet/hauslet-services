...
# Test each job
JOBS=("media-cleanup-scheduler" "booking-expiry-scheduler" "booking-completion-scheduler" "booking-checkin-out-scheduler" "payout-process-scheduler" "disbursement-retry-scheduler" "penalty-debt-collection-scheduler")
