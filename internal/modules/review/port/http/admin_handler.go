...
// AdminHandler handles HTTP requests for review admin operations
...
func NewAdminHandler(reviewService service.ReviewService, ctx context.Context, log *slog.Logger) *AdminHandler {
	return &AdminHandler{
