...
func MapListingFromSchema(schemaListing *schema.Listing) *Listing {
	...
	listing := &Listing{
		...
		SuspendedUntil:        schemaListing.SuspendedUntil,
		SuspensionReason:      schemaListing.SuspensionReason,
		...
		EmbeddingDocumentHash: schemaListing.EmbeddingDocumentHash,
...
func MapListingToSchema(domainListing *Listing) *schema.Listing {
	...
	schemaListing := &schema.Listing{
		...
		SuspendedUntil:        domainListing.SuspendedUntil,
		SuspensionReason:      domainListing.SuspensionReason,
		...
		EmbeddingDocumentHash: domainListing.EmbeddingDocumentHash,
...
func MapRentalDetailToSchema(domainDetail *RentalDetail) *schema.RentalDetail {
	...
	// Map showing availability
	if len(domainDetail.ShowingAvailability) > 0 {
