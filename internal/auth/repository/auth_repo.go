...
// NewAuthRepositoryImpl creates a new PostgreSQL repository
func NewAuthRepositoryImpl(db *gorm.DB, sessionStore session.SessionStore) *AuthRepositoryImpl {
